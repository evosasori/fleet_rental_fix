...
class CarRentalContract(models.Model):
        ...
        if product_id.property_account_income_id.id:
            ...
            raise UserError(
                _('Please define income account for this product: "%s" (id:%d).') % (
                    product_id.name,
                    product_id.id))
        print("printttttttttttttttttttttttttttttttttttttttttttttttttt",self.vehicle_id.name,income_account.id,self.cost_generated,product_id.id,inv_id.id)
        recurring_data = {
    ...
    def action_invoice_create(self):
        ...
        print("printttttttttttttttttttttttttttttttttttttttttt",self.journal_type.id)
        inv_obj = self.env['account.move']
        supplier = self.customer_id
        inv_data = {
            'ref': supplier.name,
        ...
        mail_content = _(
            ...
            'been received. <br/><br/>'
            'Please find the details below:<br/><br/>'
            '<table><tr><td>Invoice Reference<td/><td> %s<td/><tr/>'
